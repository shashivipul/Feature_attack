...
class GCN(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, dropout=0.5, lr=0.01, drop=False, weight_decay=5e-4, n_edge=1,with_relu=True,
        ...
        self.gc1 = GCNConv(nfeat, nhid, bias=self.with_bias,)
        #self.gc2 = GCNConv(nhid, nclass, bias=self.with_bias, )
        self.gc2 = GCNConv(nhid, nhid, bias=self.with_bias, )
